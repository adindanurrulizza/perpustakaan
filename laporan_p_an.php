...
<h4 align="center">Laporan Peminjaman dan Pengembalian  Buku Per Anggota</h5> 
<table  align="center"  width="53%">
<?php
$idk=$_POST['idk'];
include "koneksi/koneksi.php";
$sql_limit = "SELECT * FROM   anggota WHERE no_agt='".$idk."' ";
...
?>
          ...
          <td>Id Anggota  :<?php echo $tampi['no_agt'] ?></td>
		  <tr>
          <td>Nama Anggota :<?php echo $tampi['nama'] ?></td>
		  <tr>
...
$idk=$_POST['idk'];
include "koneksi/koneksi.php";
$sql_limit = "select peminjaman.no_peminjaman,tgl_pinjam,tgl_kembali,status,anggota.no_agt,nama,buku.no_induk_buku,judul,pengarang
from peminjaman,anggota,buku
where anggota.no_agt='".$idk."' and  peminjaman.no_agt=anggota.no_agt and peminjaman.kode_buku=buku.no_induk_buku and peminjaman.status='dipinjam' order by anggota.no_agt ";
$query=mysql_query($sql_limit);$no=1;
$baris=1;
$no=1;
