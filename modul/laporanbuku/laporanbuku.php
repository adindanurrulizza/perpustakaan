...
Echo '
<h3>Cetak Laporan buku</h3>
<form action="modul/laporanbuku/cetak.php" onsubmit="popup(this);" target="_blank" method="POST" name="postform"><table id="tabeledit">';
echo "<tr><td>
Dari Tanggal : </td>
