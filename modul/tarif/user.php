...
echo"<td><a href='?modul=user&aksi=edituser&id=$tampil[user]'>Ubah</a> | ";
echo"<a onclick=\"return confirm('Anda Yakin Menghapus Data Ini?')\" href='?modul=user&aksi=hapus&id=$tampil[user]'>Hapus</td>";
...
<tr><td>Level : </td><td>
<select name='level'><option value='Ketua'>Ketua</option><option value='Pustakawan'>Pustakawan</option></select></td></tr>
<tr><td>Alamat : </td><td>
