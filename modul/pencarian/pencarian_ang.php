...
echo '<a href="?module=pencarian&aksi=transaksi" title="Pencarian Data Transaksi"><img id="belakang" src="images/penjualan.png" width="100px"/></a>';
echo '<a href="?module=pencarian&aksi=pelanggan" title="Pencarian Data Pelanggan"><img id="belakang" src="images/customer.png" width="100px"/></a>';
echo '<a href="?module=pencarian&aksi=produk" title="Pencarian Data Produk"><img id="belakang" src="images/produk.png" width="100px"/></a>';
break;
//TAMPIL TRANSAKSI
case "buku";
