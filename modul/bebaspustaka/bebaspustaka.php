...
<b><span style="color:red">- Setelah Tombol "Bebaskan" Ditekan, Maka Anggota Bersangkutan Tidak Dapat Diaktifkan Lagi</span></b></br></br><form action="?module=bebaspustaka&aksi=tampil&cari=tampildata" method="POST">Masukkan No Anggota :<input type="text" name="no_anggota"/></form></br></br><a href="media.php?module=lihatbebaspustaka&aksi=tampil">Lihat Data Bebas Pustaka</a></center>';
if(isset($_GET['cari'])){
switch ($_GET['cari'])
{
case "tampildata";
...
echo '<script>alert(\'Anggota Perpustakaan Ini Telah Dinonaktifkan\')
	setTimeout(\'location.href="?module=bebaspustaka&aksi=tampil"\' ,0);</script>';
...
echo "<form action='?module=bebaspustaka&aksi=tampil&cari=tampildata&aksitampilkan=inputpengembalian' method='POST'>
