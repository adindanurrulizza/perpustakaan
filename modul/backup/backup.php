<form action="" method="post" name="postform">
	<div align="center">
	  <p><em>Aplikasi ini digunakan untuk <strong><a href="?module=backup">backup</a></strong> dan <strong><a href="?modul=restore">restore</a></strong> semua data yang ada didalam database &quot;<strong>Sistem Informasi Perpustakaan</strong>&quot;.</em></p>
	  <p>
	  <div id="formsubmitbutton">
	    <input type="submit" name="backup"  onclick="ButtonClicked()" value="Proses Backup" class='btn btn-primary' />
		</div>
